...
public class ComputeEngineSample {
    ...
    private static Credential authorize() throws Exception {
        ...
        //clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, new InputStreamReader(
          //      ComputeEngineSample.class.getResourceAsStream(System.getProperty("user.dir")+"/src/main/resource/client_secrets.json")));
     //   clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, new InputStreamReader( new FileInputStream(System.getProperty("user.dir")+"/src/main/resource/client_secrets.json")));
